              ...
              <div class="card-body table-responsive pad">
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                  <label class="btn btn-secondary" id="label-lampu1-nyala">
                    <input type="radio" name="lampu1" onchange="publishLampu(this)" id="option_on" autocomplete="off"><i class="fas fa-lightbulb mr-2"></i>Nyala
                  </label>
                  <label class="btn btn-secondary" id="label-lampu1-mati">
                    <input type="radio" name="lampu1" onchange="publishLampu(this)" id="option_off" autocomplete="off"><i class="fas fa-power-off mr-2"></i>Mati
                  </label>
                </div>
              </div>
              <!-- /.card-body -->
